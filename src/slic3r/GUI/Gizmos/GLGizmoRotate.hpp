...
public:
    GLGizmoRotate(GLCanvas3DFacade* parent, Axis axis);
...
public:
    ...
    GLGizmoRotate3D(GLCanvas3DFacade* parent, const std::string& icon_filename, unsigned int sprite_id, GizmoObjectManipulation* obj_manipulation);
