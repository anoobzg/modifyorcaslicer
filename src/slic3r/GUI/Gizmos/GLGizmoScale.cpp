...
GLGizmoScale3D::GLGizmoScale3D(GLCanvas3DFacade* parent, const std::string& icon_filename, unsigned int sprite_id, GizmoObjectManipulation* obj_manipulation)
...
void GLGizmoScale3D::on_render()
{
    ...
    // draw grabbers
    shader = get_shader("gouraud_light");
    if (shader != nullptr) {
        shader->start_using();
