...
private:
    ...
    std::unordered_map<CheckUIBox *, std::pair<std::string, Preset *>> m_filament_preset;
    std::unordered_map<CheckUIBox *, std::pair<std::string, Preset *>> m_machint_filament_preset;
    ...
    CheckUIBox *                                                     m_can_not_find_vendor_checkbox = nullptr;
...
/**********************************************************    Data Interaction    *******************************************************/
    ...
    void          select_curr_radiobox(std::vector<std::pair<RadioBox *, wxString>> &radiobox_list, int btn_idx);
    void          select_all_preset_template(std::vector<std::pair<CheckUIBox *, Preset *>> &preset_templates);
    void          deselect_all_preset_template(std::vector<std::pair<CheckUIBox *, Preset *>> &preset_templates);
...
private:
    ...
    std::vector<std::pair<CheckUIBox *, Preset *>>           m_filament_preset;
    std::vector<std::pair<CheckUIBox *, Preset *>>           m_process_preset;
    ...
    CheckUIBox *                                             m_can_not_find_vendor_combox     = nullptr;
...
private:
    ...
    std::vector<std::pair<CheckUIBox *, Preset *>>         m_preset;         // for printer preset bundle,printer preset, process preset export
    std::vector<std::pair<CheckUIBox *, std::string>>      m_printer_name;    // for filament and peocess preset export, collaborate with m_filament_name_to_presets
