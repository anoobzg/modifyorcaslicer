...
public:
    ...
    // debug mode
    CheckUIBox * m_developer_mode_ckeckbox   = {nullptr};
    CheckUIBox * m_internal_developer_mode_ckeckbox = {nullptr};
    CheckUIBox * m_dark_mode_ckeckbox        = {nullptr};
    TextInput *m_backup_interval_textinput = {nullptr};

    wxString m_developer_mode_def;
    wxString m_internal_developer_mode_def;
    wxString m_backup_interval_def;
    std::string m_iot_environment_def;
