...
static bool delete_filament_preset_by_name(std::string delete_preset_name, std::string &selected_preset_name)
{
    ...
    PresetCollection &m_presets = app_preset_bundle()->filaments;
...
static wxBoxSizer* create_checkbox(wxWindow* parent, Preset* preset, wxString& preset_name, std::vector<std::pair<CheckUIBox*, Preset*>>& preset_checkbox)
{
    wxBoxSizer *sizer    = new wxBoxSizer(wxHORIZONTAL);
    CheckUIBox *  checkbox = new CheckUIBox(parent);
...
static wxBoxSizer *create_checkbox(wxWindow *parent, std::string &compatible_printer, Preset* preset, std::unordered_map<CheckUIBox *, std::pair<std::string, Preset *>> &ptinter_compatible_filament_preset)
{
    wxBoxSizer *sizer    = new wxBoxSizer(wxHORIZONTAL);
    CheckUIBox *checkbox = new CheckUIBox(parent);
    sizer->Add(checkbox, 0, 0, 0);
...
static wxBoxSizer *create_checkbox(wxWindow *parent, wxString &preset_name, std::vector<std::pair<CheckUIBox *, std::string>> &preset_checkbox)
{
    wxBoxSizer *sizer    = new wxBoxSizer(wxHORIZONTAL);
    CheckUIBox *checkbox = new CheckUIBox(parent);
    sizer->Add(checkbox, 0, 0, 0);
...
static wxBoxSizer *create_select_filament_preset_checkbox(wxWindow *                                    parent,
                                                          ...
                                                          std::unordered_map<CheckUIBox *, std::pair<std::string, Preset *>> &machine_filament_preset)
{
...
static std::string get_filament_id(std::string vendor_typr_serial)
{
    ...
    std::string dir_user_presets = AppAdapter::app_config()->get("preset_folder");
	...
	: DPIDialog(parent ? parent : nullptr, wxID_ANY, _L("Create Filament"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX | wxCENTRE)
{
    ...
    basic_information->SetFont(Font::Head_16);
    ...
    presets_information->SetFont(Font::Head_16);
...
{ 
    ...
    m_can_not_find_vendor_checkbox = new CheckUIBox(this);
    ...
    m_can_not_find_vendor_text->SetFont(Font::Body_13);
...
wxBoxSizer *CreateFilamentPresetDialog::create_serial_item()
{
    ...
    static_eg_text->SetFont(Font::Body_12);
...
wxBoxSizer *CreateFilamentPresetDialog::create_button_item()
{
    ...
    m_button_create->SetFont(Font::Body_12);
...
wxBoxSizer *CreatePrinterPresetDialog::create_printer_item(wxWindow *parent)
{
    ...
    wxBoxSizer *checkbox_sizer = new wxBoxSizer(wxHORIZONTAL);
    m_can_not_find_vendor_combox = new CheckUIBox(parent);
...
wxBoxSizer *CreatePrinterPresetDialog::create_hot_bed_stl_item(wxWindow *parent)
{
    ...
    m_button_bed_stl->SetFont(Font::Body_10);

    m_button_bed_stl->SetPaddingSize(wxSize(FromDIP(30), FromDIP(8)));
    m_button_bed_stl->SetFont(Font::Body_13);
...
{ 
    ...
    m_button_bed_svg->SetFont(Font::Body_10);

    m_button_bed_svg->SetPaddingSize(wxSize(FromDIP(30), FromDIP(8)));
    m_button_bed_svg->SetFont(Font::Body_13);
...
wxBoxSizer *CreatePrinterPresetDialog::create_page1_btns_item(wxWindow *parent)
{
    ...
    m_button_page1_cancel->SetFont(Font::Body_12);
...
bool CreatePrinterPresetDialog::load_system_and_user_presets_with_curr_model(PresetBundle &temp_preset_bundle, bool just_template)
{
    ...
    if (PRESET_CUSTOM_VENDOR == m_printer_preset_vendor_selected.name || PRESET_CUSTOM_VENDOR == m_printer_preset_vendor_selected.id) {
        ...
        temp_preset_bundle = *(app_preset_bundle());
    } else {
        selected_vendor_id = m_printer_preset_vendor_selected.id;

        if (boost::filesystem::exists(boost::filesystem::path(Slic3r::user_data_dir()) / PRESET_SYSTEM_DIR / selected_vendor_id)) {
            preset_path = (boost::filesystem::path(Slic3r::user_data_dir()) / PRESET_SYSTEM_DIR).string();
...
wxBoxSizer *CreatePrinterPresetDialog::create_printer_preset_item(wxWindow *parent)
{
    ...
    combobox_title->SetFont(Font::Body_13);
...
wxBoxSizer *CreatePrinterPresetDialog::create_page2_btns_item(wxWindow *parent)
{
    ...
    m_button_page2_back->SetFont(Font::Body_12);
    ...
    m_button_create->Bind(wxEVT_LEFT_DOWN, [this](wxMouseEvent &e) {
        ...
        for (std::pair<CheckUIBox *, Preset const *> filament_preset : m_filament_preset) {
        ...
        for (std::pair<CheckUIBox *, Preset const *> process_preset : m_process_preset) {
    ...
    m_button_page2_cancel->SetFont(Font::Body_12);
...
void CreatePrinterPresetDialog::select_all_preset_template(std::vector<std::pair<CheckUIBox *, Preset *>> &preset_templates)
{
    for (std::pair<CheckUIBox *, Preset const *> filament_preset : preset_templates) { 
        filament_preset.first->SetValue(true);
    }
}

void CreatePrinterPresetDialog::deselect_all_preset_template(std::vector<std::pair<CheckUIBox *, Preset *>> &preset_templates)
{
    for (std::pair<CheckUIBox *, Preset const *> filament_preset : preset_templates) { 
...
{ 
    for (std::pair<CheckUIBox *, Preset *> preset : m_filament_preset) {
        if (preset.second) { 
    ...
    for (std::pair<CheckUIBox *, Preset *> preset : m_process_preset) {
        if (preset.second) {
            delete preset.second;
            preset.second = nullptr;
        }
    ...
    : DPIDialog(parent ? parent : nullptr, wxID_ANY, PRINTER == create_success_type ? _L("Create Printer Successful") : _L("Create Filament Successful"), wxDefaultPosition, wxDefaultSize, wxCAPTION | wxCLOSE_BOX)
{
    ...
    success_text->SetFont(Font::Head_18);
    ...
    case PRINTER: 
        ...
        break;
    case FILAMENT: m_button_ok = new Button(this, _L("OK"));
        break;
    }
    StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(0, 137, 123), StateColor::Pressed), std::pair<wxColour, int>(wxColour(38, 166, 154), StateColor::Hovered),
                            std::pair<wxColour, int>(wxColour(0, 150, 136), StateColor::Normal));
...
ExportConfigsDialog::~ExportConfigsDialog()
{
    ...
    boost::filesystem::path temp_folder(user_data_dir() + "/" + PRESET_USER_DIR + "/" + "Temp");
...
{
    for (std::pair<CheckUIBox *, Preset *> checkbox_preset : m_preset) {
        if (checkbox_preset.first->GetValue()) return true;
    }
    for (std::pair<CheckUIBox *, std::string> checkbox_filament_name : m_printer_name) {
...
{ 
    ...
    boost::filesystem::path file_path(user_data_dir() + "/" + PRESET_USER_DIR + "/" + "Temp" + "/" + (preset->name + ".json"));
...
wxBoxSizer *ExportConfigsDialog::create_export_config_item(wxWindow *parent)
{
    ...
    static_export_printer_preset_bundle_text->SetFont(Font::Body_12);
    ...
    static_export_filament_preset_bundle_text->SetFont(Font::Body_12);
...
ExportConfigsDialog::ExportCase ExportConfigsDialog::archive_filament_preset_to_file(const wxString &path)
{
    ...
    for (std::pair<CheckUIBox *, std::string> checkbox_preset : m_printer_name) {
        if (checkbox_preset.first->GetValue()) {
...
{
    // Delete the Temp folder
    boost::filesystem::path folder(user_data_dir() + "/" + PRESET_USER_DIR + "/" + "Temp");
    if (boost::filesystem::exists(folder)) boost::filesystem::remove_all(folder);

    boost::system::error_code ec;
    boost::filesystem::path user_folder(user_data_dir() + "/" + PRESET_USER_DIR);
...
void EditFilamentPresetDialog::delete_preset()
{
    ...
    if (need_delete_preset->name == app_preset_bundle()->filaments.get_selected_preset_name()) {
        AppAdapter::gui_app()->get_tab(need_delete_preset->type)->delete_preset();
        // is preset exist? exist: not delete
        Preset *delete_preset = app_preset_bundle()->filaments.find_preset(need_delete_preset->name, false);
        if (delete_preset) {
        ...
        Preset *filament_preset = app_preset_bundle()->filaments.find_preset(need_delete_preset->name);

        // is root preset ?
        bool is_base_preset = false;
        if (filament_preset && app_preset_bundle()->filaments.get_preset_base(*filament_preset) == filament_preset) {
            is_base_preset = true;
            int      count = 0;
            wxString presets;
            for (auto &preset2 : app_preset_bundle()->filaments)
        ...
        // delete preset
        std::string next_selected_preset_name = app_preset_bundle()->filaments.get_selected_preset().name;
        ...
        app_preset_bundle()->filaments.select_preset_by_name(next_selected_preset_name, true);
        for (size_t i = 0; i < app_preset_bundle()->filament_presets.size(); ++i) {
            auto preset = app_preset_bundle()->filaments.find_preset(app_preset_bundle()->filament_presets[i]);
            if (preset == nullptr) app_preset_bundle()->filament_presets[i] = app_preset_bundle()->filaments.get_selected_preset_name();
        }
    }
...
void EditFilamentPresetDialog::edit_preset()
{
    ...
    AppAdapter::gui_app()->params_dialog()->set_editing_filament_id(m_filament_id);
...
wxBoxSizer *EditFilamentPresetDialog::create_add_filament_btn()
{
    ...
    m_add_filament_btn->SetFont(Font::Body_10);
...
wxBoxSizer *EditFilamentPresetDialog::create_button_sizer()
{
    ...
    m_del_filament_btn->SetFont(Font::Body_12);
...
{
    m_preset_bundle = std::make_shared<PresetBundle>(*(app_preset_bundle()));
...
wxBoxSizer *CreatePresetForPrinterDialog::create_button_sizer()
{
    ...
    m_cancel_btn->SetFont(Font::Body_12);
...
wxPanel *PresetTree::get_root_item(wxPanel *parent, const std::string &printer_name)
{
    ...
    preset_name->SetFont(Font::Body_11);
...
wxPanel *PresetTree::get_child_item(wxPanel *parent, std::shared_ptr<Preset> preset, std::string printer_name, int preset_index, bool is_last)
{
    ...
    preset_name->SetFont(Font::Body_10);
    preset_name->SetForegroundColour(*wxBLACK);
    sizer->Add(preset_name, 0, wxEXPAND | wxALL, 5);
    ...
    if (base_id_error) {
        ...
        m_download_hyperlink->SetFont(Font::Body_10);
    ...
    edit_preset_btn->SetFont(Font::Body_10);
    ...
    del_preset_btn->SetFont(Font::Body_10);
    ...
    edit_preset_btn->Bind(wxEVT_BUTTON, [this, printer_name, preset_index](wxCommandEvent &e) {
        AppAdapter::app()->CallAfter([this, printer_name, preset_index]() { edit_preset(printer_name, preset_index); });
    });
    del_preset_btn->Bind(wxEVT_BUTTON, [this, printer_name, preset_index](wxCommandEvent &e) {
        AppAdapter::app()->CallAfter([this, printer_name, preset_index]() { delete_preset(printer_name, preset_index); });
    });
