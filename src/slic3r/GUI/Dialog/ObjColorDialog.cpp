...
int objcolor_scale(const int val) { return val * app_em_unit() / 10; }
...
ObjColorDialog::ObjColorDialog(wxWindow *                      parent,
    ...
    : DPIDialog(parent ? parent : static_cast<wxWindow *>(AppAdapter::main_panel()),
                wxID_ANY,
    ...
    , m_first_extruder_id(first_extruder_id)
{
    ...
    // BBS: for tunning flush volumes
    {
        ...
        specify_color_cluster_title->SetFont(Font::Head_14);
        ...
        current_filaments_title->SetFont(Font::Head_14);
        ...
        quick_set_title->SetFont(Font::Head_12);
...
void ObjColorPanel::update_filament_ids()
{
    if (m_is_add_filament) {
        for (auto c:m_new_add_colors) {
            ...
            AppAdapter::gui_app()->sidebar().add_custom_filament(c);
        }
    }
   //deal m_filament_ids
...
void ObjColorPanel::draw_table()
{
    ...
    for (size_t ii = 0; ii < row; ii++) {
        ...
        if (ii == 0) {
            ...
            colors_left_title->SetFont(Font::Head_14);
            ...
            colors_middle_title->SetFont(Font::Head_14);
...
wxBoxSizer *ObjColorPanel::create_color_icon_and_rgba_sizer(wxWindow *parent, int id, const wxColour& color)
{
    ...
    //rgba_title->SetFont(Font::Head_12);
