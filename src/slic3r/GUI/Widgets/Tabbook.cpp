...
static const wxFont& TAB_BUTTON_FONT     = Font::Body_14;
static const wxFont& TAB_BUTTON_FONT_SEL = Font::Head_14;
...
void TabButtonsListCtrl::OnPaint(wxPaintEvent &)
{
    ...
    const wxColour& btn_marker_color = Slic3r::GUI::get_color_hovered_btn_label();
