...
wxWebView* WebView::CreateWebView(wxWindow * parent, wxString const & url)
{
    ...
    if (webView) {
        ...
        webView->SetUserAgent(wxString::Format("BBL-Slicer/v%s (%s) Mozilla/5.0 (Windows NT 10.0; Win64; x64) "
            ...
            Slic3r::GUI::dark_mode() ? "dark" : "light"));
        ...
        auto addScriptMessageHandler = [] (wxWebView *webView) {
            ...
            Slic3r::GUI::AppAdapter::gui_app()->set_adding_script_handler(true);
            if (!webView->AddScriptMessageHandler("wx"))
                wxLogError("Could not add script message handler");
            Slic3r::GUI::AppAdapter::gui_app()->set_adding_script_handler(false);
...
#endif
            if (Slic3r::GUI::AppAdapter::gui_app()->is_adding_script_handler()) {
...
{
    if (Slic3r::GUI::app_get_bool("internal_developer_mode")
...
{
    auto dark = Slic3r::GUI::dark_mode();
