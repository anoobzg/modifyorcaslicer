    ...
    , m_value_type(value_type)
{
    ...
    GetTextCtrl()->SetFont(Font::Body_14);
    Append(_L("End"));
    Append(_L("Customize"));
    ...
    :wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize)
{
    ...
    other_layer_txt->SetFont(Font::Body_14);
    title_sizer->Add(other_layer_txt, 0, wxALIGN_CENTER | wxALIGN_LEFT, 0);
    title_sizer->AddStretchSpacer();
    title_sizer->Add(m_other_layer_print_seq_choice, 0, wxALIGN_CENTER, 0);
...
void OtherLayersSeqPanel::append_layer(const LayerSeqInfo* layer_info)
{
    ...
    choose_layer_head_txt->SetFont(Font::Body_14);
    ...
    choose_layer_to_txt->SetFont(Font::Body_14);
    ...
    const std::vector<std::string> extruder_colours = plater_get_extruder_colors_from_plater_config();
...
:DPIDialog(parent, wxID_ANY, title, pos, size, style)
{
    ...
    plate_name_txt->SetFont(Font::Body_14);
    ...
    m_bed_type_txt->SetFont(Font::Body_14);
    ...
    m_print_seq_txt->SetFont(Font::Body_14);
    ...
    spiral_mode_txt->SetFont(Font::Body_14);
    ...
    first_layer_txt->SetFont(Font::Body_14);
