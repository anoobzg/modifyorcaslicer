...
std::optional<float> calc_distance(const GLVolume &gl_volume, RaycastManager &raycaster, GLCanvas3DFacade *canvas)
{
...
bool face_selected_volume_to_camera(const Camera &camera, GLCanvas3DFacade* canvas, const std::optional<double> &wanted_up_limit)
{
