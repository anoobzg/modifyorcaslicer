...
public:
    ...
    void show_dialog(Preset::Type type, wxWindow *parent, GUI::TextInput *input, wxWindow *ssearch_btn);
...
public:
    ...
    GUI::TextInput *  search_line{nullptr};
...
public:
    SearchDialog(OptionsSearcher *searcher, Preset::Type type, wxWindow *parent, GUI::TextInput *input, wxWindow *search_btn);
    ~SearchDialog();
