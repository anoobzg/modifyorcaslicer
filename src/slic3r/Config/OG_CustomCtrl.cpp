...
{
    const std::vector<Slic3r::GUI::Line>& og_lines = opt_group->get_lines();
    for (const Slic3r::GUI::Line& line : og_lines)
    {
...
int OG_CustomCtrl::get_height(const Slic3r::GUI::Line& line)
{
...
wxPoint OG_CustomCtrl::get_pos(const Slic3r::GUI::Line& line, Field* field_in/* = nullptr*/)
{
    // BBS: new layout
    wxCoord v_pos = 0;
...
void OG_CustomCtrl::correct_window_position(wxWindow* win, const Slic3r::GUI::Line& line, Field* field/* = nullptr*/)
{
...
void OG_CustomCtrl::correct_widgets_position(wxSizer* widget, const Slic3r::GUI::Line& line, Field* field/* = nullptr*/) {
...
bool OG_CustomCtrl::CtrlLine::is_separator() const 
{ 
    return og_line.is_separator(); 
}
