...
public:
    ...
    void    correct_window_position(wxWindow* win, const Slic3r::GUI::Line& line, Field* field = nullptr);
    void    correct_widgets_position(wxSizer* widget, const Slic3r::GUI::Line& line, Field* field = nullptr);
    ...
    wxPoint get_pos(const Slic3r::GUI::Line& line, Field* field = nullptr);
    int     get_height(const Slic3r::GUI::Line& line);
