...
static const t_config_enum_values s_keys_map_IdexMode = {
    { "Pack", IdexMode_Pack },
    { "Copy", IdexMode_Copy },
    { "Mirror", IdexMode_Mirror }
};
CONFIG_OPTION_ENUM_DEFINE_STATIC_MAPS(IdexMode)

static const t_config_enum_values s_keys_map_BedDivide = {
    { "One_Area", One_Area},
    { "Four_Areas", Four_Areas  }
};
CONFIG_OPTION_ENUM_DEFINE_STATIC_MAPS(BedDivide)
...
void PrintConfigDef::init_fff_params()
{
    ...
    def->mode = comAdvanced;
   // add begin 2025/08/25
    def = this->add("enable_extruder", coBools);
    def->label = L("Enable Extruder");
    def->tooltip = L("Enable Extruder advance, auto calibration result will be overwritten once enabled.");
    def->set_default_value(new ConfigOptionBools{ false });
    def->mode = comAdvanced;
    // add end
    ...
    */
    ...
    def = this->add("idex_mode", coEnum);
    def->label = L("Idex Mode");
    def->full_label = L("Idex Mode");
    def->tooltip = L("Idex Mode");
    def->enum_keys_map = &ConfigOptionEnum<IdexMode>::get_enum_values();
    def->enum_values.push_back("Pack");
    def->enum_values.push_back("Copy");
    def->enum_values.push_back("Mirror");
    def->enum_labels.push_back("Pack");
    def->enum_labels.push_back("Copy");
    def->enum_labels.push_back(L("Mirror"));
    def->mode = comAdvanced;
    def->set_default_value(new ConfigOptionEnum<IdexMode>(IdexMode_Copy));

//2025     
    def = this->add("hot_bed_divide", coEnum);
    def->label = L("Bed divide type");
    def->tooltip = L("Bed divide types supported by the printer");
    def->enum_keys_map = &ConfigOptionEnum<BedDivide>::get_enum_values();
    def->enum_values.push_back("One_Area");
    //def->enum_values.push_back("Two_Areas");
    def->enum_values.push_back("Four_Areas");
    def->enum_labels.push_back("One_Area");
    //def->enum_labels.push_back("Two_Areas");
    def->enum_labels.push_back(L("Four_Areas"));
    def->mode = comAdvanced;
    def->set_default_value(new ConfigOptionEnum<BedDivide>(Four_Areas));
//end
...
void PrintConfigDef::init_extruder_option_keys()
{
    ...
    m_extruder_option_keys = {
        "nozzle_diameter","enable_extruder", "min_layer_height", "max_layer_height", "extruder_offset",
