...
enum IdexMode {
    IdexMode_Pack, IdexMode_Copy, IdexMode_Mirror
};
...
CONFIG_OPTION_ENUM_DECLARE_STATIC_MAPS(IdexMode)
CONFIG_OPTION_ENUM_DECLARE_STATIC_MAPS(BedDivide)
...
PRINT_CONFIG_CLASS_DERIVED_DEFINE(
    ...
    //
    ((ConfigOptionBools,              enable_extruder))
    // ((ConfigOptionEnumsGeneric,      hot_bed_divide))
    // 2025/08
    ...
    ((ConfigOptionEnum<IdexMode>,     idex_mode))
    ((ConfigOptionEnum<BedDivide>,    hot_bed_divide))
