...
void ModelInstance::set_idex_mirror_center(const Vec3d& center)
{
    m_idex_mirror_center = center;
}

Vec3d ModelInstance::get_idex_mirror_center()
{
    return m_idex_mirror_center;
}
